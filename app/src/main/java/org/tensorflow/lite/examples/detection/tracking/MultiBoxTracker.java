    ...
    for (final TrackedRecognition recognition : trackedObjects) {
      ...
      if (!TextUtils.isEmpty(recognition.title)){
        if(recognition.distance == -1.0){
          labelString = String.format("%s %.2f%% DANGER" , recognition.title, (100 * recognition.detectionConfidence), recognition.distance);
        }else if(recognition.distance == -2.0){
          labelString = String.format("%s %.2f%% FAR" , recognition.title, (100 * recognition.detectionConfidence), recognition.distance);
        }else{
          labelString = String.format("%s %.2f%% %.1fm" , recognition.title, (100 * recognition.detectionConfidence), recognition.distance);
        }
      }else{
...
//                      //? String.format("%s %.2f%% %.1fm" , recognition.title, (100 * recognition.detectionConfidence), recognition.distance)
//
//                      ?String.format("%s %.1fm" , recognition.title, recognition.distance)
//                      : String.format("%.2f", (100 * recognition.detectionConfidence));
      ...
      Log.d(TAG,"hello");
      Log.d(TAG, "labelString : " + labelString);
      //Log.d(TAG, "recognition : " + recognition);
    }
  }
